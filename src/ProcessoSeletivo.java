...
public class ProcessoSeletivo {
    public static void main(String[] args) throws Exception {
        String [] candidatos = {"ZEFERINO", "MARCIA", "PEDRO", "PAULO", "MARIA"};
    ...
    {
        String [] candidatos = {"MARIA", "MARCIA", "ZEFERINO", "PAULO", "PEDRO", "ANTONIO"};
    ...
    {
        String [] candidatos = {"MARIA", "MARCIA", "ZEFERINO", "PAULO", "ANTONIO", "PEDRO", "FABIO", "GABRIELA", "DANIELA", "MARCOS"};
